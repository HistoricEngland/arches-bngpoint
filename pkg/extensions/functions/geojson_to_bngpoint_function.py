...
class GeoJSONToBNGPoint(BaseFunction):
    ...
    def save_bngpoint(self, tile, request, is_function_save_method=True):
        ...
        os_grid = { "09":"NA", "19":"NB", "29":"NC", "39":"ND", "49":"NE", "59":"OA", "69":"OB",
        ...
        if geojsonValue != None:
            ...
            if self.config[u"bng_output_nodegroup"] == str(tile.nodegroup_id):
                ...
                if len(previously_saved_tiles) > 0:
                    ...
                    new_bng_tile = Tile().get_blank_tile_from_nodegroup_id(self.config[u"bng_output_nodegroup"],resourceid=tile.resourceinstance_id,parenttile=tile.parenttile)
